...
import autoware_msgs.msg # import DetectedObjectArray
...
if __name__ == "__main__":
    try:
        ...
        class_LM1 = LatencyMonitor("detection/lidar_detector/objects", autoware_msgs.msg.DetectedObjectArray)
        class_LM2 = LatencyMonitor("detection/shape_estimation/objects", autoware_msgs.msg.DetectedObjectArray)
        class_LM3 = LatencyMonitor("obj_detection_node/detected_objects", DetectedObjectArray)
