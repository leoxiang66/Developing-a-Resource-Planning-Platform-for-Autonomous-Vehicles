...
topic_name1 = "detection/lidar_detector/objects_markers"
topic_name2 = "detection/shape_estimation/objects_markers"
topic_name3 = "obj_detection/detected_objects"
...
class SubplotAnimation(animation.TimedAnimation):
    ...
    def _draw_frame(self, framedata):
        ...
        if math.fabs(rate1) < 9.8:
            ...
            rospy.logerr(data_to_send)
            self.pub_perception_monitor(data_to_send)
        else:
        ...
        if math.fabs(rate4) < 9.8:
            ...
            rospy.logerr(data_to_send)
            self.pub_localization_monitor(data_to_send)
        else:
